...
- [x] TASK-001 [PD0001] 从 `ApiStandard`、`MiniApi` 移除 SixLabors 版本/包引用及 `ImageHelper` 图形验证码实现和测试。
  ...
  - Verify: `rg -n -i --hidden -g '!**/bin/**' -g '!**/obj/**' -g '!**/.git/**' 'SixLabors|ImageSharp|ImageHelper|GenerateImageCaptcha' .`; `dotnet build ApiStandard/src/Perigon/Perigon.AspNetCore.Toolkit/Perigon.AspNetCore.Toolkit.csproj`; `dotnet build MiniApi/src/Perigon/Perigon.AspNetCore.Toolkit/Perigon.AspNetCore.Toolkit.csproj`
